...
const kindsOfShops = [
  {
    ...
    imageUrl: {
      uri:
        'https://avatars.mds.yandex.net/get-zen_doc/135437/pub_5d4540e2027a1500adcef2f0_5d45444935c8d800ad0d594e/scale_1200',
    },
    count: 15,
  },
  {
    ...
    imageUrl: {
      uri:
        'https://sovcominvest.ru/uploads/products/155a40b4c3151476fbbfbbbfdc1b8c90.jpg',
    },
    count: 7,
  },
  {
    ...
    imageUrl: {
      uri:
        'https://img2.goodfon.ru/original/2560x1600/0/4f/zermatt-switzerland-cermatt-6874.jpg',
    },
    count: 2,
  },
];
...
const Shops = [
  {
    ...
    imageUrl: {
      uri:
        'http://sc-globalcity.ru/sites/default/files/offers/800x800_site_mccombo_bm.jpg',
    },
      ...
      <ScrollView style={{flex: 1}}>
        <View style={{flex: 1}}>
          ...
          {this.state?.organizations?.map((organization, i) => (
            <View key={i} style={{borderColor: 'black'}}>
              <ListItem
                key={0}
                leftAvatar={{source: {uri: organization.imageUrl.uri}}}
                rightIcon={<Icon name="bars" type="font-awesome" />}
                title={organization.name}
                subtitle={'0.8 км'}
              />
              <ImageBackground
                source={{uri: organization.imageUrl.uri}}
